...
import { Eye, EyeOff, Zap, Shield, KeyRound } from "lucide-react";
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-violet-600 via-violet-700 to-indigo-800 flex-col justify-between p-12">
        ...
        <div>
          ...
          <p className="text-violet-200 text-lg leading-relaxed">
            Organize projects, assign tasks, and track every milestone — all in one place.
          </p>
          <div className="mt-10 space-y-4">
            {["Role-based access control", "Real-time task tracking", "Team collaboration"].map((f) => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-slate-50">
        <div className="w-full max-w-md">
          ...
          <p className="text-slate-500 mb-8">Join your team and start collaborating</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-amber-800">Admin Access (Optional)</span>
              </div>
              <p className="text-xs text-amber-700 mb-3 leading-relaxed">
                Have an admin secret code from your organization? Enter it below to register as an Admin.
                Leave blank to join as a Member.
              </p>
              <div className="relative">
                <KeyRound size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-amber-500" />
                <input
                  type={showCode ? "text" : "password"}
                  className="input pl-9 pr-11 bg-white border-amber-200 focus:ring-amber-400"
                  placeholder="Enter admin secret code"
                  value={form.adminCode}
                  onChange={set("adminCode")}
                />
                <button type="button" onClick={() => setShowCode(!showCode)}
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-amber-400 hover:text-amber-600 transition-colors">
