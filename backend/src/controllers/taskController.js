...
export const createTask = async (req, res) => {
  try {
    ...
    req.app.get("io").to(`project:${project._id}`).emit("task:created", populated);
...
export const updateTask = async (req, res) => {
  try {
    ...
    // Emit real-time event to all users in this project room
    req.app.get("io").to(`project:${project._id}`).emit("task:updated", populated);
...
export const deleteTask = async (req, res) => {
  try {
    ...
    // Emit real-time event to all users in this project room
    req.app.get("io").to(`project:${project._id}`).emit("task:deleted", { taskId: req.params.taskId });
